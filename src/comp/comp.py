...
print("Starts with D:")
a = [x.name for x in humans if x.name[0].upper() == "D"]
pass
print(a)
...
# Write a list comprehension that creates a list of all the ages plus
# 10.
print("Ages plus 10:")
...
# joined to the age with a hyphen, for example "David-31", for all
# humans.
...
print(g)
# Write a list comprehension that contains the square root of all the
# ages.
